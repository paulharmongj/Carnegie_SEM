...
\begin{frontmatter}
\title{An Alternative to the Carnegie Classifications: Using Structural Equation Models to Identify Similar Doctoral Institutions\thanksref{T1}}
\runtitle{A Sample Document}
\thankstext{T1}{Footnote to the title with the ``thankstext'' command.}

\begin{aug}
\author{\snm{Paul Harmon}\thanksref{t1,t2,m1}\ead[label=e1]{paulharmongj@gmail.com}},
\author{\fnms{Sarah McKnight} \thanksref{t3,m1,m2}\ead[label=e2]{second@somewhere.com}}
\author{\fnms{Laura Hildreth} \thanksref{t3,m1,m2}\ead[label=e2]{second@somewhere.com}}
\author{\fnms{Ian Godwin} \thanksref{t3,m1,m2}\ead[label=e2]{second@somewhere.com}}

\and
\author{\fnms{Mark Greenwood} \snm{Author}\thanksref{t1,m2}
\ead[label=e3]{greenwood@montana.edu}
...
\affiliation{Montana State University\thanksmark{m1}}
